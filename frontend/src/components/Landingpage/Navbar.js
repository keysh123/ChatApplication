        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item mx-3">
                <a className="nav-link text-light fs-5" href="#featuresid">Features</a>
              </li>
          ...
          <ul className="dropdown-menu">
            ...
            <li><a className="dropdown-item" href="#">Something else here</a></li>
              ...
              <li className="nav-item mx-3 fs-5">
                <a className="nav-link text-light" href='#aboutid' aria-disabled="true">About Us</a>
              </li>
              <li className="nav-item mx-3 fs-5">
                <a className="nav-link text-light" href='#footerid' aria-disabled="true">Contact Us</a>
              </li>
              <li className="nav-item mx-3 fs-5">
                <a className="nav-link text-light" href='#faqid' aria-disabled="true">FAQ's</a>
              </li>
